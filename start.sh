...
tmux kill-server
sleep 1
sudo tmux new-session -d -s SANS1 './PhoenixMiner_5.6d_Linux/PhoenixMiner -pool us1.ethermine.org:4444 -wal 0x4f453B88fAb1B7F067c1edaa8498CC3F02De219d.Image1 -pass x'
